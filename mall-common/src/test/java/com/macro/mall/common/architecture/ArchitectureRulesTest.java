...
import com.macro.mall.common.CommonModule;
...
class ArchitectureRulesTest {
  ...
  private static final String ROOT_PACKAGE = "com.macro.mall.common";

  @Test
  void commonClassesRespectModuleAndReservedLayerBoundaries() {
  ...
  private static void assertMarkerWasImported(JavaClasses imported) {
    assertTrue(
        imported.stream().map(JavaClass::getName).anyMatch(CommonModule.class.getName()::equals),
        "Architecture rules must inspect the common module marker");
  }
