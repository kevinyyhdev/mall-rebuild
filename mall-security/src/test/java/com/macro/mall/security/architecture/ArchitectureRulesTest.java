package com.macro.mall.security.architecture;

import static com.tngtech.archunit.lang.syntax.ArchRuleDefinition.classes;
import static com.tngtech.archunit.lang.syntax.ArchRuleDefinition.noClasses;
import static org.junit.jupiter.api.Assertions.assertTrue;

import com.macro.mall.security.SecurityModule;
...
class ArchitectureRulesTest {
  ...
  private static final String ROOT_PACKAGE = "com.macro.mall.security";

  @Test
  void securityClassesRespectModuleAndReservedLayerBoundaries() {
  ...
  private static void assertMarkerWasImported(JavaClasses imported) {
    assertTrue(
        imported.stream().map(JavaClass::getName).anyMatch(SecurityModule.class.getName()::equals),
        "Architecture rules must inspect the security module marker");
  }
